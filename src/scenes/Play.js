class Play extends Phaser.Scene {
    ...
    create() {
        ...
        //this.timeLeft = Math.floor(game.settings.gameTimer / 1000);
        this.timeLeft = Math.ceil(this.clock.getRemainingSeconds());
        this.timeText = this.add.text(game.config.width - borderUISize - borderPadding - 200, borderUISize + borderPadding*2, `Time: ${Math.ceil(this.clock.getRemainingSeconds())}`, scoreConfig);
